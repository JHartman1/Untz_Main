...
uint8_t NoteGrid[N_BUTTONS] = {64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 
...
void setup() {
  ...
  //////// Identify Trellis Boards /////////

  untztrument.setLED(0); // Turn on LED 0
  delay(500);            // Wait 500 ms (0.5 Seconds)
  untztrument.setLED(1); // Turn on LED 1
  delay(500);            // Wait 500 ms (0.5 Seconds)
  untztrument.setLED(2); // Turn on LED 2
  delay(500);            // Wait 500 ms (0.5 Seconds)
  untztrument.setLED(3); // Turn on LED 3
  delay(500);            // Wait 500 ms (0.5 Seconds)
  untztrument.clrLED(0); // Turn off all LEDs
  untztrument.clrLED(1);
  untztrument.clrLED(2);
  untztrument.clrLED(3);
